      ...
      >
        <CBox>
          ...
          <CBox>
            ...
            <CButton shadow="lg" variant-color="blue">F</CButton>
            <CButton shadow="lg" variant-color="cyan">T</CButton>
            <CButton shadow="lg" variant-color="pink">P</CButton>
            <CButton shadow="lg" variant-color="red">Y</CButton>
          </CBox>
        </CBox>
        <CBox
          v-chakra="{
