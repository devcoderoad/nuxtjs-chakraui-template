<template>
  ...
  >
      ...
      <CBox my="4" py="2" mx="auto" d="flex">
        ...
        >
          <CHeading size="sm" mb="3" mt="3"
            >Lorem ipsum, dolor sit amet consectetur adipisicing elit.</CHeading
          >
          <CImage
        ...
        <CBox
          ...
          <CBox as="p" fontSize="sm"
            ...
            nesciunt doloribus asperiores quisquam!</CBox
          >
          <CLink href="#" fontSize="sm" fontWeight="bolder"
            >visit &raquo;</CLink
          >
    ...
    <CHeading size="xs" mt="2" textAlign="right">View all products</CHeading>
  </CBox>
</template>
