<template>
  <div v-chakra pos="relative" overflow="hidden">
    <CBox
      :w="[
        'full',
    ...
    >
      <CBox :px="[3, 6]">
        ...
        <CText as="p" :my="[6, 9]">
          ...
          consectetur repudiandae delectus? Sapiente asperiores quibusdam nihil,
          totam necessitatibus velit quidem odio dolorem ad maiores fuga.
        </CText>
